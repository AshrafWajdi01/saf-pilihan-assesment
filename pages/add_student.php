...
<div class="xp-window">
    ...
    <div class="xp-tabs">
        ...
        <a href="add_student.php" class="tab active">Add</a>
        <a href="list_students.php" class="tab">View</a>
    </div>
        ...
        <form method="POST">
            <table class="xp-form-table">
                <tr>
                    ...
                    <td><input type="text" id="name" name="name" class="xp-input" required></td>
                </tr>
                <tr>
                    <td><label for="email">Email</label></td>
                    <td><input type="email" id="email" name="email" class="xp-input" required></td>
                </tr>
                <tr>
                    <td><label for="course">Course</label></td>
                    <td><input type="text" id="course" name="course" class="xp-input" required></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
